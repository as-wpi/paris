...
from paris import attribution, budgeting, drawdown, jump, ratios, regimes, relative, returns, risk, tables
from paris.summary import stats

_MODULES = (returns, risk, drawdown, ratios, relative, tables, regimes, jump)
